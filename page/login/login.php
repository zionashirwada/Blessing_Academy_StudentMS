...
<html>
<head>
  <title>Login || Blessing Academy Fees System</title>
</head>
...
<div class="container" style="width: 100%">
  ...
  <div class="row">
    ...
    <div id="login-box" style="margin-top: 45px;">
        <div class="header_box"><center>Admin Login Portal</center></div>
        <div class="logo">
            <h1 class="logo-caption">Blessing Academy Student Management System</h1>
        </div>
        <div id="loader_area" style="display: none;"><?php loader(); ?></div>
        <div class="controls" id="login_body">
            <div id="error_msg" class="error_msg" style="color: #4355f6;display: none;">
        ...
        <div class="footer_login" style="">Developed By: <a href=""><font style="font-size: 19px;font-weight: bold;color: #4355f6">Ashirwada Manamudali</font></a></div>
    </div>
