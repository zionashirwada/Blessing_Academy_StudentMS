...
<div class="btn-toolbar list-toolbar">
     ...
     <button class="btn btn-primary" data-title="Add Product" onclick="get_subject_form('insert')"><i class="fa fa-plus"></i> Add Teacher</button>
</div>
</center>
<table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tr>
              ...
              <th><center>Teacher Code</center></th>
