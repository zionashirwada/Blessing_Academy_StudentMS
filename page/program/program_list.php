...
<div class="col-md-12">
            <div class="dashboard_box">
                <div class="box_header">Class List</div>
                <div class="box_body">
                   <div class="pull-rightt" style="margin-top: -20px;">
            <center><button class="button" onclick="get_program_form('insert')">+ Add Class</button></center>
          </div>
           ...
           <table id="" class="display" width="100%">
            ...
            <tr>
              ...
              <td class="td_list1">class Start</td>
              <td class="td_list1">class End</td>
              <td class="td_list1">Teacher</td>
