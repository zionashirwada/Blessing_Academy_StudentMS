...
<?php
 ...
 ?>
  ...
  <div class="form-group">
    <label class="control-label" for="inputName"><b>Class Name</b></label>
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-exclamation-sign"></i></span>
        <input class="form-control" data-error="Please enter name field." id="date" value="" placeholder="Enter class Name"  type="text" name="name"  required="" />
    </div>
  ...
  <div class="form-group">
    <label class="control-label" for="inputName"><b>Start class Time</b></label>
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-exclamation-sign"></i></span>
        <input class="form-control" data-error="Please enter name field." id="date" value="" placeholder="Enter Start class Time"  type="date" name="start"  required="" />
    </div>
 ...
 <div class="form-group">
    <label class="control-label" for="inputName"><b>End class Time</b></label>
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-exclamation-sign"></i></span>
        <input class="form-control" data-error="Please enter name field." id="date" value="" placeholder="Enter End class Time"  type="date" name="end"  required="" />
    </div>
    <div id="err_product_date" class="error" style="padding-left: 40px;"></div>
  </div>
...
<div class="form-group">
 ...
 echo "</div><div class='select_box'>Select Teacher</div><div class='select_box1'>";
