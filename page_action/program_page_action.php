...
if(isset($_POST['add_program_form'])){
  ...
  $site->form_input("Class Name","insert_name","name");
  $site->form_input("Class Start","insert_name","start","date");
  $site->form_input("Class End","insert_name","end","date");

  echo "<div class='form-group'>
        <label class='control-label' for='inputName'><b>Select Class Type</b></label>
        <div class='input-group'>
            ...
            <option value='1'>Package Class</option>
            <option value='2'>Monthly Class</option></select>
            </div></div>";
 ...
 echo "</div><div class='select_area_header'>Select Teacher</div><div class='select_area_body'>";
  $program_ob->select_subject();
 echo "</div><br />";

?>

<button class="btn btn-lg btn-primary btn-block" name="insert" type="submit" onclick="program_action('insert')"><span class="glyphicon glyphicon-floppy-save" ></span> Save Class</button>
...
if(isset($_POST['update_program_form'])){
  ...
  $site->form_input("Class Name","insert_name","name","text","exclamation-sign",$info['name']);
  $site->form_input("Class Start","insert_name","start","date","exclamation-sign",$info['start']);
  $site->form_input("Class End","insert_name","end","date","exclamation-sign",$info['end']);
  ...
  echo "<div class='form-group'>
        ...
        <div class='input-group'>
            ...
            <select class='form-control' onchange='program_type_select()' id='program_type'>
            <option value='-1'>Select Class Type</option>
            <option value='1' $select_type1>Package Class</option>
            <option value='2' $select_type2>Monthly Class</option></select>
            </div></div>";
...
<button class="btn btn-lg btn-primary btn-block" name="insert" type="submit" onclick="program_action('update',<?php echo $id; ?>)"><span class="glyphicon glyphicon-floppy-save"></span> Update Class</button>
...
if(isset($_POST['delete_program_form'])){
  ...
  <center>
    <h3>Do You Want To Delete This Class</h3><br/>
...
if(isset($_POST['set_payment_list'])){
  ...
  if($program[$pid]['type']==1){
    echo "<center><h1>The Class Is Package Class</h1></center>";
    return;
  }
