...
if(isset($_POST['student_list'])){
   ...
   ?>
   <button class="btn btn-primary hidden-print pull-right" onclick="window.print()"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> Print</button>
<div id="print_area">
...
<table id="datatable" style="width: 100%">
	<tr>
		...
		<td class="student_list_td1">Grade</td>
