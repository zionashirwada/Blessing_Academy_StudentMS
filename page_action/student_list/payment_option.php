...
if(isset($_POST['payment_option_overview'])){
    ...
    get_program_overview_percent_css(75);
     ...
     <div class="col-md-7">
     	<table width="100%">
     		<tr>
     			<td class="payment_td_1">Subject: </td>
     			<td class="payment_td_2"><?php echo $program[$program_id]['name']; ?></td>
     		</tr>
     		<tr>
     			<td class="payment_td_1">Grade: </td>
     		...
     		<tr>
     			<td class="payment_td_1">Detail Year: </td>
     			<td class="payment_td_2"><?php echo "$year"; ?></td>
     		</tr>
     		<tr>
     			<td class="payment_td_1">Detail Month: </td>
    ...
    <?php
  	 ...
  	 make_dive_payment("total fee (LKR)",$info['total_fee'],"fa fa-inr");
  	 make_dive_payment("total Pay (LKR)",$info['total_pay'],"fa fa-eur");
  	 make_dive_payment("total due (LKR)",$info['total_due'],"fa fa-gbp");
    echo "</div>";
...
if(isset($_POST['program_overview_send_sms'])){
	...
	foreach ($info as $key => $value) {
		...
		if($p_status==$status || $status=="All"){
			...
			if($type==1){
				$msg.="Your admission fee $fee LKR for '$program_name'";
			}
			else{
				$msg.="Your monthly fee $fee LKR for '$month_name-$year' in '$program_name'";
			}
			...
			if($p_status=="Paid"){
				...
				$msg.=" is not completed. Your due amount $due LKR. Please pay your due amount$within.";
			}
