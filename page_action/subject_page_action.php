...
if(isset($_POST['get_subject_form'])){
 ...
 <div class="row">
    ...
    //$site->form_input($level,$name,$id,$type="text",$icon="exclamation-sign",$value="",$ex="",$req="yes")
       $site->form_input("Teacher Name","insert_name","sub_name");
       $site->form_input("Teacher Code","insert_name","sub_code");
    ?>
...
<div class="row">
    <div class="col-xs-12 col-sm-12">
      <?php
       $site->form_input("Teacher Name","insert_name","sub_name","text","exclamation-sign",$name);
       $site->form_input("Teacher Code","insert_name","sub_code","text","exclamation-sign",$code);
    ?>
        <div id="err_product_date" class="error"></div>
...
if(isset($_POST['delete_subject_form'])){
  ...
  <center>
    <h3>Do You Want To Delete This Teacher</h3><br/>
