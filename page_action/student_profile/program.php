...
<button class="btn btn-primary btn-xs" onclick="add_program()" style="margin-right: 4px; padding: 10px" title="Add Program" data-title="Add Program" ><span class="glyphicon glyphicon-plus"></span> Add Class</button>
...
<table class="display" style="width: 100%">
  ...
  <tr>
    ...
    <td class="program_td">Class Name</td>
...
<center>
<button class="btn btn-primary btn-xs" onclick="save_add_program()" style="margin-right: 4px; padding: 10px" title="Add Program" data-title="Add Program" ><span class="glyphicon glyphicon-plus"></span> Add Class</button>
</center>
<div id="res"></div>
...
<b class="txt">Select Batch</b>
  <select class="select" id="edit_batch_id">
   ...
   <center>
    <button class="btn btn-primary btn-xs" style="margin-right: 4px; padding: 10px" title="Update Program" onclick="update_program(<?php echo "$admit_id"; ?>)">Update Class</button>
...
if(isset($_POST['view_program'])){
  ...
  <div class="row">
    ...
    <div class="col-md-3">
      ...
      <button class="view_program_btn" onclick="admission_recept(<?php echo $admit_id; ?>)">Admission Reciept</button>
      </center>
    </div>
  </div>
<?php
...
<div id="print_area">
  ...
  <table width="100%">
     ...
     <tr>
       <td class="td_view1">Class Start:</td>
       <td class="td_view2"><?php echo $program_start; ?></td>
     </tr>
     <tr>
       <td class="td_view1">Class End:</td>
       <td class="td_view2"><?php echo $program[$program_id]['end']; ?></td>
     </tr>
     <tr>
       <td class="td_view1">Batch Day:</td>
