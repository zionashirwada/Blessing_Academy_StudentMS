...
if(isset($_POST['delete_payment_form'])){
  ...
  ?>
    ...
    <center>
    <h3>Do You Want To Delete This Payment</h3><br/>
...
<table width="100%">
	<tr style="text-align: center;">
		...
		<td class="td_list1">Class Name</td>
   ...
   ?>
    ...
    <td class="td_list2"><?php echo "$year"; ?></td>
		<td class="td_list2"><?php echo "$pay LKR"; ?></td>
...
<div class="row">
	...
	<div class="col-md-10">
        ...
        <div class="payment_next_body">
           <table width="100%">
             <tr>
                <td class="cls_payment_td_paid c_unpaid">Class Name:</td>
              ...
              <tr>
                ...
                <td class="cls_payment_td_paid2"><input id="set_student_fee_value" class="payment_input" type="number" readonly value="<?php echo $fee; ?>"></td>
              </tr>


           </table>
        </div>
        <button style="border-radius: 0px; padding: 10px;" class="btn btn-md btn-block btn_view c_unpaid" onclick="save_set_fee(<?php echo "$save_fee"; ?>)">Attended to Classes</button>
        ...
        <div class="portlet">
          <div class="portlet-title">
            ...
            <div class="actions">
              ...
              <a href="javascript:;" onclick="add_pay_form(<?php echo "$payment_id"; ?>)" class="view_btn2">
          ...
          <div class="portlet-body">
             <div class="row" style="">
               <div class="col-md-5">
                 <table width="100%">
                  <tr>
                    <td class="td_profile1" style="width: 125px;">Class Name:</td>
               ...
               <div class="col-md-7">
                  <table width="100%">
                    <tr style="text-align: center;">
                      ...
                      <td class="td_list1">Pay</td>
                      <td class="td_list1">Date</td>
                      <td class="td_list1">Invoiced By</td>
                      <td class="td_list1">Action</td>
                    </tr>
                    <?php
                  ...
                  <table width="100%">
                   ...
                   <tr>
                    ...
                    <td class="td_profile2"><?php echo "<b>$fee</b> LKR" ?></td>
                  </tr>
                  <tr>
                    <td class="td_profile1 td_fee">Total Pay:</td>
                    <td class="td_profile2"><?php echo "<b>$total_pay</b> LKR" ?></td>
                  </tr>
                  <tr>
                    <td class="td_profile1 td_fee">Total Due:</td>
                    <td class="td_profile2"><?php echo "<b>$due</b> LKR" ?></td>
                  </tr>
                  <tr>
