...
if(isset($_POST['add_batch_form'])){
   ...
   //$site->form_input($level,$name,$id,$type="text",$icon="exclamation-sign",$value="",$ex="",$req="yes")
    ...
    $site->form_input("Start Batch Time","insert_name","batch_start","text","exclamation-sign","","Ex: 2021");
    $site->form_input("End Batch Time","insert_name","batch_end","text","exclamation-sign","","Ex: 2022");
    ?>
...
if(isset($_POST['delete_batch_form'])){
  ...
  <center>
    <h3>Do you want to Delete This Grade</h3><br/>
