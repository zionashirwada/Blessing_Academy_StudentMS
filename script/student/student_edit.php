    ...
    <div class="col-md-12">
      <div class="avatar">
        <center>
          ...
          <a href="student_profile.php?get_id=<?php echo $student_id; ?>&tab=program" target="_blank"><button title='View Program' class="btn btn_profile" >View Class</button></a>
      ...
      <div class="row">
        ...
        <div class="col-md-10">
          <table style="width: 100%">
            ...
            <tr>
              <td class="td_profile td_profile1">User Name: </td>
            ...
            <tr>
              <td class="td_profile td_profile1">Whatsapp Mobile: </td>
...
<div style="padding-top:30px" class="box_body" >
    ...
    <form action="student_action.php" method="post" enctype="multipart/form-data">
      ...
      $site->form_input("Student User Name","nick","nick","text","exclamation-sign","$nick","","yes");
      ...
      $site->form_input("Whatsapp mobile","student_mobile","student_mobile","number","exclamation-sign","$student_mobile","","no");
...
<div style="padding-top:30px" class="box_body" >
  ...
  ?>
  <div class='form-group'>
    <label class='control-label' for='inputName'><b>Medium</b></label>
    <div class='input-group'>
      <span class='input-group-addon'><i class='glyphicon glyphicon-exclamation-sign'></i></span>
      <select class='form-control'  name='religion' id='brand_add' class='cs-select cs-skin-border' required="">
        <option value="Muslim">Sinhala</option>
        <option value="Hindu">English</option>
