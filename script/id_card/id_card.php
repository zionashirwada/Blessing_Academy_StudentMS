...
foreach ($data as $key => $info) {
  ...
  $school=$this->make_string($school,30);
  ...
  $birth_day=$student_info1['birth_day'];
  $birth_day=$this->make_string($birth_day,31);
  ...
  <div class="id_box_body">
    ...
    <div style="margin-top: 8px;"></div>
      <div class="field">
	      ...
	      <div class="name_field">
	      <span class="id_field">Birth Day :</span> <span class="inf"><?php echo "$birth_day"; ?></span>
	      </div>
